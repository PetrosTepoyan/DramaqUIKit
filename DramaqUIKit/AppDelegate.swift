...
//        print(try! viewContext.count(for: NSFetchRequest(entityName: "Record")))
//        for i in 1..<20 {
//            let record = Record(context: viewContext)
//            record.id = UUID()
//            record.price = Double(1000 + Int.random(in: -500...500))
//            record.place =  ["Gucci", "Magnit", "Driver", "Ciro"].randomElement()!
//            record.date = Date()
//            record.category = Category.allCases.randomElement()!.rawValue
//            record.location = "51.507222,-0.1275"
//            record.purchaseMethod = "Card"
////            print("Filled", record.place!)
//
//            do {
...
//        }
    ...
    lazy var persistentContainer: NSPersistentCloudKitContainer = {
        ...
        */
        let container = NSPersistentCloudKitContainer(name: "DramaqUIKit")
